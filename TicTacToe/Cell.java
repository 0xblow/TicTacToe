...
// The Class that models each individual cell on the game board.
public class Cell {
	...
	public Cell(int row, int col) {
		// Initialising the variables row, col.
		this.row = row;
		this.col = col;
	...
	public void paint(Graphics g) {
		...
		// Drawing the symbol in the position.
	...
	public void clear() {
		// Setting the value of content to Empty.
